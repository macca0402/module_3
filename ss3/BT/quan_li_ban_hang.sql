...
insert into customer(c_id,customer_name,age) values 
(1,'Minh Quan',10),
(2,'Ngoc Oanh',20),
(3,'Hong Ha',50);

insert into orders(customer_id,date_order,total_price) values 
(1,'2006-3-21',null),
(2,'2006-3-23',null),
(1,'2006-3-16',null);
...
select o.o_id, o.date_order,o.total_price from orders o ;
