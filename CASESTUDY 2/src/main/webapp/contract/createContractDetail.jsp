...
<nav style="margin-top: 0" class="navbar navbar-expand-lg bg-light">
    ...
    <form action="/contract-servlet?action=createContractDetail" method="post">
        <div class="col-md-6">
            <label class="form-label">Mã hợp đồng</label>
            <input name="ma_hop_dong" type="text" class="form-control" >
        </div>
        <div class="col-md-6">
            <label class="form-label">Mã dịch vụ đi kèm</label>
            <input name="ma_dich_vu_di_kem" type="text" class="form-control" >
        </div>
        <div class="col-md-6">
            <label  class="form-label">Số lượng</label>
            <input name="so_luong" type="text" class="form-control">
        </div>
        <div class="col-md-6">
            <button type="submit" class="btn btn-primary">Tạo mới hợp đồng chi tiết</button>
        </div>
    </form>
